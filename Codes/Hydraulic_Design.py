...
L = 0.192 #Length of a single tube
Y = 10e-3 #Tube pitch
...
N_baffle = 8 #Number of baffles PER SIDE, CAREFUL. Each baffle often on both sides! (multipass shell)
...
for m_dot in np.linspace(0.15,0.7,100):
    ...
    #----------------------
    Dp_c_overall = Dp_shell(V_sh,N) + 20e3 + rho*v_noz_c**2 #Last term accounts for BOTH nozzles. 2nd term is calibrated by Longley 2022 and 2017B data on Moodle
    #-------------------------------
